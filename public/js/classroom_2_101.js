        ...
        for (var i = 0; i < 90; i++) {
            ...
            if (above < mousex && mousex < above + width && side < mousey && mousey < side + height) {
                ...
                fetch('/renewal_url',  //seat_regist/renewal_urlのURLに値を送る http://localhost/SeatRegist/subject_id=4/user_id=1/class_time=3
                {
                    ...
                    //座席名以外のユーザidと科目idと授業回も上と同じように添付する
                })


            //var jsonName = JSON.stringify(name);    //nameに入ってる値をjson文字列に変換
            //$("[name=json_name]").val(jsonName)     //bladeのhiddenに入れる
...
btn.addEventListener('click', () => {
    ...
    fetch('seat_regist/renewal_url',  //seat_regist/renewal_urlのURLに値を送る http://localhost/SeatRegist/subject_id=4/user_id=1/class_time=3
            {
                method: 'POST',  //POSTメソッドを指定
                headers:  { 'Content-Type'  :  'application/json' },    //jsonを指定
                body:   JSON.stringify(regist)  //postname変数の値をjson形式に変換して添付
...
/*
//context.fillStyle = 'rgb(255,255,255)'; //塗りつぶしの色は赤　描画コードの前に書く
context.strokeStyle = 'rgb(00,00,00)'; //枠線の色は黒
//左から20、上から80の位置に、幅40、高さ40の四角形(枠のみ)を描く
context.strokeRect(20,80,40,40);    //A列
context.strokeRect(20,120,40,40);
context.strokeRect(20,200,40,40);
context.strokeRect(20,240,40,40);
context.strokeRect(20,320,40,40);
context.strokeRect(20,360,40,40);

context.strokeRect(60,80,40,40);    //B列
context.strokeRect(60,120,40,40);
context.strokeRect(60,200,40,40);
context.strokeRect(60,240,40,40);
context.strokeRect(60,320,40,40);
context.strokeRect(60,360,40,40);

context.strokeRect(100,80,40,40);   //C列
context.strokeRect(100,120,40,40);
context.strokeRect(100,200,40,40);
context.strokeRect(100,240,40,40);
context.strokeRect(100,320,40,40);
context.strokeRect(100,360,40,40);

context.strokeRect(180,40,40,40);   //D列
context.strokeRect(180,80,40,40);
context.strokeRect(180,160,40,40);
context.strokeRect(180,200,40,40);
context.strokeRect(180,280,40,40);
context.strokeRect(180,320,40,40);
context.strokeRect(180,360,40,40);

context.strokeRect(220,40,40,40);   //E列
context.strokeRect(220,80,40,40);
context.strokeRect(220,160,40,40);
context.strokeRect(220,200,40,40);
context.strokeRect(220,280,40,40);
context.strokeRect(220,320,40,40);
context.strokeRect(220,360,40,40);

context.strokeRect(260,40,40,40);   //F列
context.strokeRect(260,80,40,40);
context.strokeRect(260,160,40,40);
context.strokeRect(260,200,40,40);

context.strokeRect(300,280,40,40);  //G列
context.strokeRect(300,320,40,40);
context.strokeRect(300,360,40,40);

context.strokeRect(340,280,40,40);  //H列
context.strokeRect(340,320,40,40); 
context.strokeRect(340,360,40,40); 

context.strokeRect(380,160,40,40);  //I列
context.strokeRect(380,200,40,40);

context.strokeRect(420,160,40,40);  //J列
context.strokeRect(420,200,40,40);

context.strokeRect(460,160,40,40);  //K列
context.strokeRect(460,200,40,40);
context.strokeRect(460,280,40,40);
context.strokeRect(460,320,40,40);
context.strokeRect(460,360,40,40);

context.strokeRect(500,280,40,40);  //L列
context.strokeRect(500,320,40,40);
context.strokeRect(500,360,40,40);

context.strokeRect(540,40,40,40);   //M列
context.strokeRect(540,80,40,40);
context.strokeRect(540,160,40,40);
context.strokeRect(540,200,40,40);

context.strokeRect(580,40,40,40);   //N列
context.strokeRect(580,80,40,40);
context.strokeRect(580,160,40,40);
context.strokeRect(580,200,40,40);
context.strokeRect(580,280,40,40);
context.strokeRect(580,320,40,40);
context.strokeRect(580,360,40,40);

context.strokeRect(620,40,40,40);   //O列
context.strokeRect(620,80,40,40);
context.strokeRect(620,160,40,40);
context.strokeRect(620,200,40,40);
context.strokeRect(620,280,40,40);
context.strokeRect(620,320,40,40);
context.strokeRect(620,360,40,40);

context.strokeRect(700,80,40,40);   //P列
context.strokeRect(700,120,40,40);
context.strokeRect(700,200,40,40);
context.strokeRect(700,240,40,40);
context.strokeRect(700,320,40,40);
context.strokeRect(700,360,40,40);

context.strokeRect(740,80,40,40);   //Q列
context.strokeRect(740,120,40,40);
context.strokeRect(740,200,40,40);
context.strokeRect(740,240,40,40);
context.strokeRect(740,320,40,40);
context.strokeRect(740,360,40,40);

context.strokeRect(780,80,40,40);   //R列
context.strokeRect(780,120,40,40);
context.strokeRect(780,200,40,40);
context.strokeRect(780,240,40,40);
context.strokeRect(780,320,40,40);
context.strokeRect(780,360,40,40);
*/